...
1. Record the choice as a decision (an `IDEA-NNN` note or, once L1 is unlocked, a spec).
...
3. If the project grows multiple stacks/surfaces, propose splitting into stack-specific coders at L2/L3.
...
- At L1 you must run `/smoke` (build + type + test gate) before claiming any task done. At L0 there's no formal gate yet; verify your change runs.
