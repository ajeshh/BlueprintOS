...
| [IDEA-011](IDEA-011-conscience-pause-and-self-discipline.md) | BOSS's own override discipline — conscience pause as session-level escape hatch | exploring | full 8-dimension architectural audit; one real gap named (no session-level off-switch — canvas R&H #1 made concrete); IDEA-008's override discipline applied fractally to the whole conscience; Phase 1 (pause primitive) queued for v0.23 |
